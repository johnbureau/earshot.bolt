...
DROP POLICY IF EXISTS "Event hosts can manage their event financials" ON public.event_financials;
DROP POLICY IF EXISTS "Creators can view event financials they're involved in" ON public.event_financials;

-- Create the event_financials table if it doesn't exist
